...
The implementation intentionally avoids automatic web downloads in v0.1. Public endpoints
change, EIA series require careful product/region selection, and repeatable investment research
requires versioned raw inputs. A downloader should be added only with raw-response caching,
series metadata, API-key configuration, and data-vintage tracking.
